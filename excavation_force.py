...
if __name__ == '__main__':
    ...
    # t, tx, ty = model.ZengModel()
    # print(f"t:{t} tx:{tx} ty:{ty}")
    # t, tx, ty = model.SwickPerumpralModel()
    # print(f"t:{t} tx:{tx} ty:{ty}")
    # t, tx, ty = model.McKyesModel()
    # print(f"t:{t} tx:{tx} ty:{ty}")
    # t, tx, ty = model.GillVandenBergModel()
    # print(f"t:{t} tx:{tx} ty:{ty}")
    t, tx, ty = model.SwickPerumpralModel()
    print(f"{tx} {ty}")
